...
read_document = get_ingestor("path")
split_text = get_chunker("semantic_page")
...
def process_and_add_documents(collection,folder_path:str):
    ...
    for file_path in files:
        if file_path.lower().endswith('.pdf'):
            ...
            print(f"Skipping {os.path.basename(file_path)} (only PDF supported by semantic page chunker)")
